var app = new Vue({
    ...
    methods: {
        ...
        queenBee() {
            ...
            [11, 5], [11, 6], [11, 14], [11, 15], [11, 16], [11, 21], [11, 22], [11, 25],
            [11, 26], [12, 5], [12, 6], [12, 15], [12, 16], [12, 21], [12, 22], [12, 25],
            [12, 26], [13, 16], [13, 17], [14, 17]];
            for (let n = 0; n < p.length; n++) {
                Vue.set(this.values[p[n][0]], p[n][1], 1);
            }
        },
        nebula() {
            ...
            this.values = arr;
            var p = [[9, 10], [9, 11], [9, 12], [9, 13], [9, 14], [9, 15], [9, 17], [9, 18],
            [10, 10], [10, 11], [10, 12], [10, 13], [10, 14], [10, 15], [10, 17], [10, 18],
            [11, 17], [11, 18], [12, 10], [12, 11], [12, 17], [12, 18], [13, 10], [13, 11],
            [13, 17], [13, 18], [14, 10], [14, 11], [14, 17], [14, 18], [15, 10], [15, 11],
            [16, 10], [16, 11], [16, 13], [16, 14], [16, 15], [16, 16], [16, 17], [16, 18],
            [17, 10], [17, 11], [17, 13], [17, 14], [17, 15], [17, 16], [17, 17], [17, 18]];
            for (let n = 0; n < p.length; n++) {
                Vue.set(this.values[p[n][0]], p[n][1], 1);
            }
        }
